...
use App\Entity\Talent\TalentTable;
use App\Form\Talent\TalentTableType;
use App\Repository\Talent\TalentTableRepository;
...
final class TalentTableController extends AbstractController
{
    ...
    {
        return $this->render('bo/talents/talent_table/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/talents/talent_table/new.html.twig', [
    ...
    public function edit(Request $request, TalentTable $talentTable, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/talents/talent_table/edit.html.twig', [
            'talent_table' => $talentTable,
            'form' => $form,
        ]);
    }
