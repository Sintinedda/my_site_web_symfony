...
final class SubraceController extends AbstractController
{
    ...
    {
        return $this->render('subrace/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('subrace/new.html.twig', [
            'subrace' => $subrace,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('subrace/show.html.twig', [
            'subrace' => $subrace,
        ]);
    }
    ...
    public function edit(Request $request, Subrace $subrace, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('subrace/edit.html.twig', [
            'subrace' => $subrace,
            'form' => $form,
        ]);
    }
