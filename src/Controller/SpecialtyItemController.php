...
final class SpecialtyItemController extends AbstractController
{
    ...
    {
        return $this->render('specialty_item/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('specialty_item/new.html.twig', [
    ...
    {
        return $this->render('specialty_item/show.html.twig', [
            'specialty_item' => $specialtyItem,
        ]);
    }
    ...
    public function edit(Request $request, SpecialtyItem $specialtyItem, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('specialty_item/edit.html.twig', [
            'specialty_item' => $specialtyItem,
            'form' => $form,
        ]);
    }
