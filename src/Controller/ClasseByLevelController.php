...
final class ClasseByLevelController extends AbstractController
{
    ...
    {
        return $this->render('classe_by_level/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('classe_by_level/new.html.twig', [
    ...
    {
        return $this->render('classe_by_level/show.html.twig', [
            'classe_by_level' => $classeByLevel,
        ]);
    }
    ...
    public function edit(Request $request, ClasseByLevel $classeByLevel, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('classe_by_level/edit.html.twig', [
            'classe_by_level' => $classeByLevel,
            'form' => $form,
        ]);
    }
