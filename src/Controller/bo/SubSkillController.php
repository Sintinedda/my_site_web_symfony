...
final class SubSkillController extends AbstractController
{
    ...
    {
        return $this->render('bo/sub_skill/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/sub_skill/new.html.twig', [
            'sub_skill' => $subSkill,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_sub_skill_show', methods: ['GET'])]
    public function show(SubSkill $subSkill): Response
    {
        return $this->render('bo/sub_skill/show.html.twig', [
            'sub_skill' => $subSkill,
        ]);
    }
    ...
    public function edit(Request $request, SubSkill $subSkill, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/sub_skill/edit.html.twig', [
            'sub_skill' => $subSkill,
            'form' => $form,
        ]);
    }
