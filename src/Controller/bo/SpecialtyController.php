...
final class SpecialtyController extends AbstractController
{
    ...
    {
        return $this->render('bo/specialty/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/specialty/new.html.twig', [
            'specialty' => $specialty,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('bo/specialty/show.html.twig', [
            'specialty' => $specialty,
        ]);
    }
    ...
    public function edit(Request $request, Specialty $specialty, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/specialty/edit.html.twig', [
            'specialty' => $specialty,
            'form' => $form,
        ]);
    }
