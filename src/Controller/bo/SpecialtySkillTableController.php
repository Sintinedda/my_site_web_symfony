...
use App\Form\SpecialtySkillTableType;
...
final class SpecialtySkillTableController extends AbstractController
{
    ...
    {
        return $this->render('bo/specialty_skill_table/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/specialty_skill_table/new.html.twig', [
            'specialty_skill_table' => $specialtySkillTable,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_specialty_skill_table_show', methods: ['GET'])]
    public function show(SpecialtySkillTable $specialtySkillTable): Response
    {
        return $this->render('bo/specialty_skill_table/show.html.twig', [
            'specialty_skill_table' => $specialtySkillTable,
        ]);
    }
    ...
    public function edit(Request $request, SpecialtySkillTable $specialtySkillTable, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/specialty_skill_table/edit.html.twig', [
            'specialty_skill_table' => $specialtySkillTable,
            'form' => $form,
        ]);
    }
