...
final class RaceController extends AbstractController
{
    ...
    {
        return $this->render('bo/race/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/race/new.html.twig', [
            'race' => $race,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('bo/race/show.html.twig', [
            'race' => $race,
        ]);
    }
    ...
    public function edit(Request $request, Race $race, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/race/edit.html.twig', [
            'race' => $race,
            'form' => $form,
        ]);
    }
