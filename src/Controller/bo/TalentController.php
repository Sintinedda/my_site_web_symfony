...
final class TalentController extends AbstractController
{
    ...
    {
        return $this->render('bo/talent/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/talent/new.html.twig', [
            'talent' => $talent,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('bo/talent/show.html.twig', [
            'talent' => $talent,
        ]);
    }
    ...
    public function edit(Request $request, Talent $talent, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/talent/edit.html.twig', [
            'talent' => $talent,
            'form' => $form,
        ]);
    }
