...
final class ClasseController extends AbstractController
{
    ...
    {
        return $this->render('bo/classe/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/classe/new.html.twig', [
            'classe' => $classe,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('bo/classe/show.html.twig', [
            'classe' => $classe,
        ]);
    }
    ...
    public function edit(Request $request, Classe $classe, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/classe/edit.html.twig', [
            'classe' => $classe,
            'form' => $form,
        ]);
    }
