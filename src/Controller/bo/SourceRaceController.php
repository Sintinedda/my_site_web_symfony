...
final class SourceRaceController extends AbstractController
{
    ...
    {
        return $this->render('bo/source_race/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/source_race/new.html.twig', [
    ...
    {
        return $this->render('bo/source_race/show.html.twig', [
            'source_race' => $sourceRace,
        ]);
    }
    ...
    public function edit(Request $request, SourceRace $sourceRace, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('bo/source_race/edit.html.twig', [
            'source_race' => $sourceRace,
            'form' => $form,
        ]);
    }
