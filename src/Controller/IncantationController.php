...
final class IncantationController extends AbstractController
{
    ...
    {
        return $this->render('incantation/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('incantation/new.html.twig', [
    ...
    {
        return $this->render('incantation/show.html.twig', [
            'incantation' => $incantation,
        ]);
    }
    ...
    public function edit(Request $request, Incantation $incantation, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('incantation/edit.html.twig', [
            'incantation' => $incantation,
            'form' => $form,
        ]);
    }
